...
import { FaUser, FaLock, FaEye, FaEyeSlash, FaExclamationTriangle, FaHeartbeat, FaPlus } from 'react-icons/fa';
...
const PatientLogin = () => {
  ...
  return (
    <LoginContainer>
      ...
      >
        <LoginHeader>
          <LoginTitle>Patient Login</LoginTitle>
          <LoginSubtitle>Access your medical records and appointments</LoginSubtitle>
        </LoginHeader>
        ...
        <Form onSubmit={handleSubmit}>
          ...
          <FormLinks>
            <FormLink href="#">Create an Account</FormLink>
